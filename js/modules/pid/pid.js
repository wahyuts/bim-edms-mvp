...
export function render(container) {
  renderCrudPage(container, {
    ...
    apiResource: "pid",
    stateKey: "documents:pid",
    permissionModule: "document",
    description: "Filtered view from Document Register for P&ID documents.",
    rowFilter: (documentItem) => documentItem.discipline === "PID",
    prepareData: (data, record) => ({ ...normalizeDocumentFormData(data, record), discipline: "PID" }),
